-- =========================================================
-- 0025 — RINGKASAN BOQ→PENAWARAN: ISI DESKRIPSI DENGAN KATEGORI
-- Prasyarat: 0001–0024
-- =========================================================
--
-- Form & PDF penawaran menampilkan kolom `deskripsi` sebagai label baris.
-- Pada 0023 nilai kategori masuk ke kolom `nama` (tidak ditampilkan),
-- sehingga baris hasil tarikan tampak kosong deskripsinya.
--
-- Perbaikan: isi `deskripsi` (dan `nama`) dengan nama kategori besar,
-- mis. "Set & Properti", "Equipment Rent". Sisanya tetap sama:
-- satu baris per kategori, nilai = Σ subtotal_jual (termasuk hari & waktu).
-- =========================================================
...
begin
  ...
  -- Satu baris ringkasan per kategori besar. deskripsi (label yang tampil)
  -- diisi nama kategori. Nilai = Σ subtotal_jual (termasuk hari & waktu),
