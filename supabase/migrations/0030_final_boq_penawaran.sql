-- =========================================================
-- 0030 - PENANDA FINAL BOQ & PENAWARAN; GERBANG KONVERSI INVOICE
-- Prasyarat: 0001-0029
-- =========================================================
--
-- Tambah kolom final_pada pada boq & quotations (penanda, bukan pengunci;
-- admin tetap bisa edit). Hanya penawaran yang sudah Final (final_pada
-- terisi) yang boleh dikonversi menjadi invoice.
-- =========================================================

alter table boq add column if not exists final_pada timestamptz;
alter table quotations add column if not exists final_pada timestamptz;
